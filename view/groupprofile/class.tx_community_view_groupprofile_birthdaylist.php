...
*  Copyright notice
*
*  (c) 2008-2009 Frank Nägler <typo3@naegler.net>
*  All rights reserved
*
 ...
 */
class tx_community_view_groupprofile_BirthdayList extends tx_community_view_AbstractView {
	...
	public function render() {
		...
		$template->addLoop('members', 'member', $this->userModel);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/community/view/groupprofile/class.tx_community_view_groupprofile_birthdaylist.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/community/view/groupprofile/class.tx_community_view_groupprofile_birthdaylist.php']);
}
