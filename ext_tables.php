...
$feUsersTempColumns = array (
	'tx_community_statusmessage' => array (
		'exclude' => 1,
		'label'   => 'LLL:EXT:community/lang/locallang_db.xml:fe_users.tx_community_statusmessage',
		'config'  => array (
			'type' => 'input',
			'size' => '30',
			'max'  => '160'
